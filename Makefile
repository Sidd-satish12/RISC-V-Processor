...
STAGE_EXECUTE_FILES = verilog/sys_defs.svh verilog/alu.sv verilog/mult.sv verilog/branch.sv verilog/mem.sv
...
# Special rule for icache_subsystem with its dependencies - DISABLED
